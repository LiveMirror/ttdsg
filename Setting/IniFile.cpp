...
/*=========================================================================
  ...
  -------------------------------------------------------------------------
   Job : Opens an ini file or creates a new one if the requested file
         doesnt exists.
/*========================================================================*/
bool CIniFile::OpenIniFile (const char * FileName)
{
	char   Str [255];
	char   *pStr;
	struct ENTRY *pEntry;
	...
	while (fgets (Str, 255, m_pIniFile) != NULL)
	{
		...
		{
			FreeAllMem ();
			MessageBox(NULL,"testOpenIniFile2","ÖØ´ó´íÎó",MB_OK);
			return FALSE;
		}
...
*========================================================================*/
void CIniFile::WriteString (const char *pSection, const char *pKey, const char *pValue)
{
	EFIND List;
	char  Str [255];
...
*========================================================================*/
void CIniFile::WriteBool (const char *pSection, const char *pKey, bool Value)
{
	char Val [2] = {'0',0};
	if (Value != 0) { Val [0] = '1'; }
...
*========================================================================*/
void CIniFile::WriteInt (const char *pSection, const char *pKey, int Value)
{
...
*========================================================================*/
void CIniFile::WriteDouble (const char *pSection, const char *pKey, double Value)
{
...
*========================================================================*/
const char *CIniFile::ReadString (const char *pSection, const char *pKey, const char *pDefault)
{
	EFIND List;
...
*========================================================================*/
bool CIniFile::ReadBool (const char *pSection, const char *pKey, bool Default)
{
	char Val [2] = {"0"};
...
*========================================================================*/
int CIniFile::ReadInt (const char *pSection, const char *pKey, int Default)
{
	char Val [12];
...
*========================================================================*/
double CIniFile::ReadDouble (const char *pSection, const char *pKey, double Default)
{
	double Val;
...
*========================================================================*/
bool CIniFile::DeleteKey (const char *pSection, const char *pKey)
{
	EFIND         List;
	struct ENTRY *pPrev;
	struct ENTRY *pNext;
...
struct ENTRY *CIniFile::FindSection (const char *pSection)
{
	char Sec  [130];
	char iSec [130];
	struct ENTRY *pEntry;
...
bool CIniFile::FindKey  (const char *pSection, const char *pKey, EFIND *pList)
{
	char Search [130];
	char Found  [130];
	char Text   [255];
...
bool CIniFile::AddItem (char Type, const char *pText)
{
...
bool CIniFile::AddItemAt (struct ENTRY *pEntryAt, char Mode, const char *pText)
{
...
bool CIniFile::AddSectionAndKey (const char *pSection, const char *pKey, const char *pValue)
{
	char Text [255];
...
void CIniFile::AddKey (struct ENTRY *pSecEntry, const char *pKey, const char *pValue)
{
	char Text [255];
	sprintf (Text, "%s=%s", pKey, pValue);
